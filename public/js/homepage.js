  ...
  (source.id = "hvid"),
    ...
    window.addEventListener("resize", function () {
      var e = window.matchMedia("(max-width: 1181px)"),
        t = (document.getElementById("vid"), document.getElementById("hvid"));
      e.matches
    ...
    (function (e) {
      ...
      (i.m = e),
        ...
        (i.p = "./");
      var a = (this.webpackJsonpdesigners = this.webpackJsonpdesigners || []),
        c = a.push.bind(a);
      (a.push = t), (a = a.slice());
...
function validateForm() {
  ...
  if (
    (producePrompt("Thank you for contacting us!", "message-error", "#2efddb"),
    !0 === n && !0 === s && !0 === i && !0 === !0)
  ) {
    var c = {
      fname: e,
